...
function GarbageIcon(props) {
  return (
    ...
    >
      <path
        opacity={0.4}
        d="M19.643 9.488c0 .068-.533 6.809-.837 9.646-.19 1.74-1.313 2.797-2.997 2.827-1.293.029-2.56.039-3.805.039-1.323 0-2.616-.01-3.872-.04-1.627-.038-2.75-1.115-2.931-2.826-.313-2.847-.837-9.578-.846-9.646a.794.794 0 01.19-.558.71.71 0 01.524-.234h13.87c.2 0 .38.088.523.234.134.158.2.353.181.558z"
        fill="#F13535"
      />
      <path
